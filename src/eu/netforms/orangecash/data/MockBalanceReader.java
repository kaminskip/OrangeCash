...
public class MockBalanceReader implements IBalanceReader {
	...
	private void addTrans(Update update){
		update.addTrans("12.06.2013", "-2,50 PLN", "", "", "ZAKUP PRZY U��YCIU KARTY W KRAJU ROLLO-CATERING", "ROLLO-CATERING");
		update.addTrans("08.06.2013", "-25,30 PLN", "-25,30 PLN", "-25,30 PLN", "ZAKUP PRZY U��YCIU KARTY W KRAJU", "Zabka SA ");
		update.addTrans("08.06.2013", "-9,00 PLN", "-9,00 PLN", "-9,00 PLN", "ZAKUP PRZY U��YCIU KARTY W KRAJU", "McDonalds");
		...
		update.addTrans("04.06.2013", "-6,80 PLN", "-6,80 PLN", "-6,80 PLN", "ZAKUP PRZY U��YCIU KARTY W KRAJU", "RESTAURACJA");
	}
